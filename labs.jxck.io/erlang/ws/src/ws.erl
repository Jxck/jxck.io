...
main(_) ->
    ...
    #{ fin := true,
       ...
       length := 3,
       payload := <<"aaa">>
     } = (decode(<<129,131,225,158,107,175,128,255,10>>)),
    ...
    #{ fin := true,
       ...
       length := 10,
       payload := <<"aaaaaaaaaa">>
     } = (decode(<<129,138,151,143,237,50,246,238,140,83,246,238,140,83, 246,238>>)),
    ...
    #{ fin := true,
       ...
       opcode := text_frame,
       length := 125,
       payload := <<"aaaaaaaaaabbbbbbbbbbccccccccccddddddddddeeeeeeeeeeffffffffffgggggggggghhhhhhhhhhiiiiiiiiiijjjjjjjjjjkkkkkkkkkkllllllllll12345">>
     } = (decode(<<129,253,60,232,250,154,93,137,155,251,93,137,155,
    ...
    #{ fin := true,
       ...
       opcode := text_frame,
       length := 126,
       payload := <<"aaaaaaaaaabbbbbbbbbbccccccccccddddddddddeeeeeeeeeeffffffffffgggggggggghhhhhhhhhhiiiiiiiiiijjjjjjjjjjkkkkkkkkkkllllllllll123456">>
     } = (decode(<<129,254,0,126,228,133,108,232,133,228,13,137,133,
    ...
    #{ fin := true,
       ...
       opcode := text_frame,
       length := 127,
       payload := <<"aaaaaaaaaabbbbbbbbbbccccccccccddddddddddeeeeeeeeeeffffffffffgggggggggghhhhhhhhhhiiiiiiiiiijjjjjjjjjjkkkkkkkkkkllllllllll1234567">>
     } = (decode(<<129,254,0,127,217,202,129,113,184,171,224,16,184,
    ...
    #{ fin := true,
       ...
       opcode := text_frame,
       length := 128,
       payload := <<"aaaaaaaaaabbbbbbbbbbccccccccccddddddddddeeeeeeeeeeffffffffffgggggggggghhhhhhhhhhiiiiiiiiiijjjjjjjjjjkkkkkkkkkkllllllllll12345678">>
     } = (decode(<<129,254,0,128,60,209,19,175,93,176,114,206,93,176,
