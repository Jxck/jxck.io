...
illegal:/\S/,contains:[e.C_BLOCK_COMMENT_MODE,{begin:/;/},a]}]}}})());hljs.registerLanguage("http",(()=>{"use strict";return e=>{
...
aliases:["yml","YAML"],contains:b}}})());hljs.registerLanguage("erlang",(()=>{"use strict";return e=>{
...
},contains:[u]},s,e.QUOTE_STRING_MODE,b,o,l,d,{begin:/\.$/}]}}})());hljs.registerLanguage("json",(()=>{"use strict";return n=>{const e={
...
begin:/>/,relevance:0}]}]}}})());hljs.registerLanguage("cpp",(()=>{"use strict";function e(e){
...
n.aliases=["cc","c++","h++","hpp","hh","hxx","cxx"],n}})());hljs.registerLanguage("sql",(()=>{"use strict";return e=>{
...
/* build:  2020/08/15 */
/* custom: bash, css, erlang, html, http, js, json, ruby, (x)sdp, sh, sql, (x)svg, text, (x)url, xml, yaml, cpp */
