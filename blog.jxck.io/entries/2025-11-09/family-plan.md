...
1Password は、個人向けでも $3/月の有料プランしかない。
...
しかし、もし 1 つでも 1Password Business を運用している組織に参加し、Business アカウントを発行された場合、以下のようなバナーが表示される。

![無料ファミリーアカウントを申し込む](free-family-account.png#306x429)
...
企業として社員に「1Password 導入補助」などの形で、個別に Individual プランを補助しているような運用の場合もあるだろう。もちろん Individual よりも Business の方が高いが、大規模ならボリュームディスカウントもあるようなので、企業提供に切り替えてしまう手もあるかもしれない。
