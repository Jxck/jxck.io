...
![Safe for Travel](safe-for-travel.png#253x121)

Business では、自分だけでなく管理者が有効/無効を切り替えることもできる。

![Business アカウントでのコントロール](business-control.png#245x179)

有効にすれば、無効に戻すまで 1Password を開いても中身が空っぽになる。

![空っぽの 1Password](empty-1password.png#625x373)
...
例えば、1Password を開くように命じられた時、Travel Mode も解除するように求められて、拒否できるのかは不明だ。
