...
遺族としては、「そういう意図がわかればできる限り尊重するが、わからなければ一番上の選択肢が選ばれる」ということになる。したがって、希望があれば書いておいてほしい。
...
筆者からすれば、無駄なページが多く、大事な記入欄の無いエンディングノートばかりだった。そこで、様々な事例、特に地方自治体がネットで配布しているものが多々あるため、それらを参考に「欲しい全項目を網羅する自作のエンディングノート」を作ることにした。
...
そして、相続などに際し「いつまでに申請してください」といった期限が、割と短い期間で発生すると、仕事をしながら手続きに駆け回るのは、正直大変だ。弁護士などに頼めるのかもしれないが、費用もかなりかかるだろう。
...
引退して家にいる親に、仕事の合間を縫って手作りのノートを渡した筆者が「忙しいから」と言われた気持ちは、推して量ってほしい。
