...
このサイトの、ここまでのエントリのフィードは次のようになった。
...
どちらも URI でいいのでは？という気がするが、たとえばエントリの id は、 URI が変わっても同じものを使うらしい。そのため、エントリの URI を変える可能性を考え、別途振ることが多いとのこと。
...
サイトの HTML に、 Feed をもつことを `<meta>` タグで記述した。
