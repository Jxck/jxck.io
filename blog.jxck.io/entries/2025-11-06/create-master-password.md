...
これまで使ってきた Master Password を共通で使えなくなってしまうと、新しく Master Password を作る必要が出る。複数を運用するのは 1Password の方針とは異なり、またブラウザ拡張やアプリなどでアカウントのスイッチが面倒になるため、新しい Master Password で既存のアカウントを更新するといった必要が出てしまうのだ。
