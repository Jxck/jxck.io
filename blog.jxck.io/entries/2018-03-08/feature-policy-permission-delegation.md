...
まず Feature Policy のモチベーションとして、*機能の制限* と *権限の移譲* という 2 つのニーズを解説する。
...
一方で、こうした許可を iframe に読み込んだクロスオリジンのコンテンツに対していかに付与するかという方法についても、長いこと議論されてきた。
...
この辺の扱いについてはよくわかっていないが、現時点では実装ベースで判断する必要がありそうだ。
