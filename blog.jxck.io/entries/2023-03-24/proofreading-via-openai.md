...
文体をどんなに揃えたところで、誤字脱字があるとやはりクオリティが低く感じるし、そこさえ押さえられていれば、他のスタイル統一は訓練である程度なんとかなる。
...
ChatGPT の Proofreading プロンプトは、頻出ユースケースの 1 つだ。そして、これは日本語でも動作する。
...
試しに [前回のブログ](https://blog.jxck.io/entries/2023-02-28/jquery-has-forgiving-problem.html) の原稿を校正した(月 1 回は書きたいという個人的な目標を達成するために、月末に大急ぎで書いたため、誤字脱字だらけだった)。
