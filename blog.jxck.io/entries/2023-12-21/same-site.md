...
結果、世界中の広告プラットフォームや、認証連携や、SNS のボタンなどで用いられるあらゆる 3rd Party Cookie には、`SameSite=None` が付けられた。(対応が難しい場合は、サービスで使っている Cookie 全てにとりあえず `SameSite=None` を付与するといった対応もあった。)
