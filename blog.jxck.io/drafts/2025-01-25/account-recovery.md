...
家に災害用の備蓄を用意するのと同様、毎年年明けに「アカウント防災訓練」を個人的に実施するようになって数年経つ。

観点は「 **今、持っているものを全て失っても、リカバリできるだろうか?** 」だ。

現代のアカウントの管理は、リテラシがある程度高い人間にとっても、十分に複雑になってきている。

"*Password Less*" が叫ばれているが、現状 Password は無くなっているというより集約されている。つまり "*Less Password*" で残る「最後の Password」をどう守るかが、災害時リカバリの課題だ。これを失って全てが詰むと、筆者にとっては人生を半分失うのに近い損失になりかねない。

今年の成果と現状を振り返りつつ、災害時にデジタルアカウントをどう守るかについて考えたい。


## 注意

このアカウント防災訓練は、個人的に思うところがあって行っているものであり、特に答えを出しているつもりはない。

また、見直してみること自体はお勧めするが、ここに書くやり方を人に勧めたいわけでもない。
...
Passkey で Password を無くせるかもしれない。でも Passkey を保存した iCloud にはどう入るのか?
...
Password は覚えていても、二要素認証が設定されていたら、、、それって SMS だっけ? それとも YubiKey?
...
基本的には、チェーンはシンプルな方が良い。筆者の場合は基本的に全て 1Password に保存し、1Password にさえ入れれば、ほぼ全て復旧できる状態だ。そのうえで、利便性のために中間にいくつかのコピーが挟まっているような状態にしている。
...
また、こうしたビッグテックは、それこそ隣の島で何かあったとき、どうなるんだろう?と思ったりもする。そういう心配をするなら OSS の Password マネージャなどを入れるのが筋だろうが、それにしても 1Password が便利すぎるし、一応カナダの会社だし、中の人(今は違うが)にも知り合いがいて個人的な安心感もあるので、ここにルートを預けている。
...
2FA は、簡単な Password が使い回されていた時代に、後付けで「それだけでは入れなくする」目的で追加された側面が大きいと考えている。すでに Password マネージャで複雑な Password を登録し、さらに追加の要素を足しているのであれば、その時点でほとんどの攻撃に対策はできている。
...
そして、最後に考えないといけないのは、その Password Manager のリカバリだ。これは、Google でも Apple でも 1Password でも、最後には Password が出てくる。他に頼りにくい「ルート」であるサービスがリカバリ手段として提供できる手段は実は少なく、結局そこは Password を消せていないからだ。
...
そもそも、預けるにしても紙は心もとない。USB に入れたり CD に焼くか? メディアも結構簡単に壊れるからなぁ。一番安全なのは、金属か。ドッグタグに刻印しておけば、簡単には破損しなさそうだ。
...
ということで、とりあえずドッグタグを採用して、Secret Key を刻み込んだものを作り、それを災害時に持ち出す防災カバンに取り付けて、物理バックアップについては終わることにした。
...
しかし、筆者はこの性質をバックアップとして使い、記憶ベースの Password と SMS で認証できるサービスに、1Password の Secret Key をバックアップしている。(もちろん、それとはわからない形で)
