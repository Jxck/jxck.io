...
![開始時に 23:50 までのデータを処理し、次は 00:10 にそこまでの処理を行い、以降は直近 1 時間のデータを処理する。](2-2.timeline.drawio.svg)

3: 最初に 23:10 より前のものを一旦処理しておき、00:10 には直近 1 時間のデータを処理する。

![最初に 23:10 より前のものを一旦処理しておき、 00:10 には直近 1 時間のデータを処理する。](2-3.timeline.drawio.svg)
...
![タスク終了から 10 分後に次のタスクを開始する](4-3.timeline.drawio.svg)
...
![前のタスクが終了していない場合の実行判断が必要](4-4.timeline.drawio.svg)
