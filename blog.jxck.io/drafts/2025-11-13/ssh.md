...
これを防ぐために、 Git のコミットには SSH の鍵を使って署名をつけることができる。署名を検証すれば、間違いなく SSH 鍵の持ち主であることがわかり、持ってない他人のなりすましを防ぐことができる。
...
これで、署名したコミットを Push すれば、 GitHub に表示する際に公開鍵を用いた検証が行われ、正しければコミットにバッヂが表示される。
