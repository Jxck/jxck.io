...
きっちり毎月ではなかったが、 1 ヶ月に 1 本は継続している。
...
Web のことをただひたすら 24 時間議論するイベントで、主に深夜(早朝?)の枠を担当した。
...
ただ、スライドは持ち込みで、 PC 切り替えがあったため、今回スライドを一個にまとめ、 Zoom 上で話者だけ切り替える構成にしたところ、よりスピード感が出た。
