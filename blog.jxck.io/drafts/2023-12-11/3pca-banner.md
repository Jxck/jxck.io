...
法律の目的が、実装方法の規制ではないという点は、再度認識しておきた点だ。そこを取り違えると、「3rd Party Cookie が使えなくなったのなら、 1st Party Cookie でやればいい」といった解釈に走りがちだ。 1st Party Cookie であっても、やっていることが「トラッキングである」という認識がある場合は、法的な規制の範疇となる可能性はある。

また、 GitHub のようにトラッキングを無くし「バナーが必要ない」ことを確信したい場合も、最終的には "Ask your lawyer" になると思われる。
...
ここまでを踏まえて、現実世界ではどのようなバナーが実装されているのかを見てみよう。
...
さて我が国はどうだろうか? 最後は日本を代表してデジタル庁を見てみる。
