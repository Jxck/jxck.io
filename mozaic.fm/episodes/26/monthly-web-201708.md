...
- Chrome 61 Beta
    - [http://blog.chromium.org/2017/08/chrome-61-beta-javascript-modules.html](http://blog.chromium.org/2017/08/chrome-61-beta-javascript-modules.html)
    ...
    - PSA: WebRTC M61 Release Notes
       ...
       - [http://labs.jxck.io/webrtc/mediastream/](http://labs.jxck.io/webrtc/mediastream/)
- Chrome 62 Dev
...
- Chrome dev/beta/stable が同時にインストールできるように
    - [http://blog.chromium.org/2017/08/run-multiple-versions-of-chrome-side-by.html](http://blog.chromium.org/2017/08/run-multiple-versions-of-chrome-side-by.html)
...
- Firefox 57 Nightly
    ...
    - ReadableStream が実装
        ...
        - [https://bugzilla.mozilla.org/show_bug.cgi?id=1272697](https://bugzilla.mozilla.org/show_bug.cgi?id=1272697)
        - WritableStream はまだ
    - ロゴが新しく
        - [http://rockridge.hatenablog.com/entry/2017/08/17/235034](http://rockridge.hatenablog.com/entry/2017/08/17/235034)
